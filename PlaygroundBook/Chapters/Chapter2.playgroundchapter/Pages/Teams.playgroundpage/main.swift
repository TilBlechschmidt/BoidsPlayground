 ...
 **Note:** All teams you add will have the three rules we previously used enabled by default on this page. You will learn how to do this yourself in a bit. Oh, and you should **not** create teams bigger than 5.000 fish (it fries the simulation)!
*/
